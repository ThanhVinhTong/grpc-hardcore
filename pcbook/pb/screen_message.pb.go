...
type Screen struct {
	...
	Panel         Screen_Panel           `protobuf:"varint,2,opt,name=panel,proto3,enum=pcbook.Screen_Panel" json:"panel,omitempty"`
...
const file_screen_message_proto_rawDesc = "" +
	"\n" +
	"\x14screen_message.proto\x12\x06pcbook\"\x91\x02\n" +
	"\x06Screen\x12\x1b\n" +
	"\tsize_inch\x18\x01 \x01(\x02R\bsizeInch\x12*\n" +
	"\x05panel\x18\x02 \x01(\x0e2\x14.pcbook.Screen.PanelR\x05panel\x129\n" +
	"\n" +
	"resolution\x18\x03 \x01(\v2\x19.pcbook.Screen.ResolutionR\n" +
	"resolution\x12\x1e\n" +
	"\n" +
...
var file_screen_message_proto_depIdxs = []int32{
	0, // 0: pcbook.Screen.panel:type_name -> pcbook.Screen.Panel
	2, // 1: pcbook.Screen.resolution:type_name -> pcbook.Screen.Resolution
