...
type Keyboard struct {
	...
	HasBacklit    bool                   `protobuf:"varint,2,opt,name=has_backlit,json=hasBacklit,proto3" json:"has_backlit,omitempty"`
...
func (x *Keyboard) GetHasBacklit() bool {
	if x != nil {
		return x.HasBacklit
	}
	return false
...
const file_keyboard_message_proto_rawDesc = "" +
	"\n" +
	"\x16keyboard_message.proto\x12\x06pcbook\"\x97\x01\n" +
	"\bKeyboard\x12/\n" +
	"\x06layout\x18\x01 \x01(\x0e2\x17.pcbook.Keyboard.LayoutR\x06layout\x12\x1f\n" +
	"\vhas_backlit\x18\x02 \x01(\bR\n" +
	"hasBacklit\"9\n" +
	"\x06Layout\x12\v\n" +
